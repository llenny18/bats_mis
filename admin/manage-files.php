              ...
              <div class="card mb-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input <?php if(isset($_GET['file_id'])){ echo " readonly "; }  ?> type="text" required class="form-control" name="user_id" id="basic-default-user-id" placeholder="User ID" value="<?php  if(isset($_GET['file_id'])){ echo $fileDataInfo['user_id']; } else{ echo $_SESSION['admin_id'] ?? ''; } ?>" />
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="basic-default-user-type">User Type</label>
                      <div class="col-sm-10">
                        <input readonly type="text" required class="form-control" name="user_type" id="basic-default-user-type" placeholder="User Type" value="admin" />
                      </div>
                    </div>
                    <div class="row mb-3">
