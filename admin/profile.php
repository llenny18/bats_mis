...
if (isset($_POST['changeicon']) && isset($_FILES['upload'])) {
  ...
  if (in_array($file['type'], $allowedTypes) && $file['size'] <= 800000) {
    ...
    // Update query
    $stmt = $conn->prepare("UPDATE users SET user_icon = ? WHERE user_id = ?");
                  ...
                  <form id="formAccountSettings" method="POST">
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="firstName" name="user_id" value="<?= $userData['user_id']  ?>" readonly autofocus />
                      </div>
                      <div class="mb-3 col-md-6">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="organization" name="role" value="<?= $userData['role']  ?>" />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label class="form-label" for="phoneNumber">Phone Number</label>
                        <div class="input-group input-group-merge">
                          <span class="input-group-text">PH (+639)</span>
                          <input type="text" id="phoneNumber" name="contact_number" class="form-control" placeholder="0934234422" value="<?= $userData['contact_number']  ?>" />
                        </div>
                      </div>
                      <div class="mb-3 col-md-6">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="zipCode" name="password" placeholder="231465" value="<?= $userData['password']  ?>" maxlength="6" />
                      </div>
